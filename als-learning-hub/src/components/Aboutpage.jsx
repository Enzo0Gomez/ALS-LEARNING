      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="max-w-3xl">
          ...
          <p className="mt-6 text-lg leading-8 text-ink-soft">
            The Alternative Learning System (ALS) is a parallel learning system of the
            Department of Education that provides a practical option for Filipinos who
            cannot access formal schooling. Learning sessions follow a schedule agreed
            upon by learners and their learning facilitators.
          </p>
        </div>
